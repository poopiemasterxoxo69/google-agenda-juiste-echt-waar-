      ...
      for (const key in cellEvents) {
        ...
        eventsInCell.forEach((event, i) => {
          ...
          if (cell) {
            ...
            taak.style.background = gradient; taak.style.border = '1px solid rgba(255,255,255,0.22)'; taak.style.color = '#fff'; taak.style.borderRadius = '12px'; taak.style.padding = '10px 12px'; taak.style.fontSize = mobile ? '16px' : '15px'; taak.style.zIndex = 2; taak.style.boxShadow = '0 4px 16px #0004, inset 0 1px 0 rgba(255,255,255,0.25)'; taak.style.whiteSpace = 'normal'; taak.style.overflow = 'hidden'; taak.style.cursor = 'pointer'; taak.style.minHeight = '46px'; taak.style.lineHeight = '1.3'; taak.style.wordWrap = 'break-word';
